...
const CommunityPostDetail: NextPage = () => {
  ...
  const [curiosity, { loading: curiosityLoading }] = useMutation(
  ...
  if (!data?.ok) return <Error statusCode={404} title={data?.message} />;
  return (
    <Layout canGoBack>
      <div>
        ...
        <div className="flex mb-3 px-4 cursor-pointer pb-3  border-b items-center space-x-3">
          ...
          <div>
            ...
            <Link href={`/users/profiled/${data?.post?.user?.id}`}>
